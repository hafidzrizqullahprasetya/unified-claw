...
export const inventory_reservations = pgTable(
...
export const customer_messages = pgTable(
  'customer_messages',
  {
    id: serial('id').primaryKey(),
    customer_id: integer('customer_id').notNull(),
...
export const payment_webhook_logs = pgTable(
...
export const event_audit_log = pgTable(
  'event_audit_log',
  {
    id: serial('id').primaryKey(),
    store_id: integer('store_id').notNull(),
