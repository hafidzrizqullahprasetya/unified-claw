...
export class CustomerService {
  ...
  async listCustomers(storeId: number, limit = 50, offset = 0) {
    const db = getDb();
  ...
  async updateCustomer(storeId: number, customerId: number, data: UpdateCustomerInput) {
    const db = getDb();
  ...
  async deleteCustomer(storeId: number, customerId: number) {
    const db = getDb();
  ...
  async getCustomerByPhone(storeId: number, phone: string) {
    const db = getDb();
